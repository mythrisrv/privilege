                        ...
                        <div className="mb-3">
                          <FormControl sx={{ m: 1, width: 273 }}>
                            ...
                            >
                              ...
                              <MenuItem value={30}>Members</MenuItem>
                          ...
                          <div className="mb-3">
                            <FormControl sx={{ m: 1, width: 273 }}>
                              ...
                              >
                                ...
                                <MenuItem value={10}>INR-Rupee</MenuItem>
                                <MenuItem value={20}>USD-Dollar</MenuItem>
                                <MenuItem value={30}>EUR-Euro</MenuItem>
                                <MenuItem value={10}>AED-Dirham</MenuItem>
                              </Select>
                            </FormControl>
                          </div>
                        </Col>
                          ...
                          <div className="mb-3">
                            <FormControl sx={{ m: 1, width: 273 }}>
                              ...
                              >
                                ...
                                <MenuItem value={10}>MM-DD-YYYY</MenuItem>
