...
const {updateDistrict} = require('../controller/districtController');
const {deleteDistrict} = require('../controller/districtController');
const {getDistrictsListOptions} = require('../controller/districtController');
const {getDistrictData} = require('../controller/districtController');
const {getDistrictList} = require('../controller/districtController');
